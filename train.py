...
def main(args=None):
    ...
    for epoch_num in range(parser.epochs):
        ...
        torch.save(retinanet.state_dict(), './models/{}_retinanet_{}.pt'.format(parser.dataset, epoch_num))

    retinanet.eval()

    torch.save(retinanet.state_dict(), './models/model_final.pt')
